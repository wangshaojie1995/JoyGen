...
class Audio2Feature():
    ...
    def get_sliced_feature(self,feature_array, vid_idx, audio_feat_length= [2,2],fps = 25):
        ...
        #print(vid_idx, center_idx, left_idx, right_idx, len(selected_feature), selected_feature[0].shape)
    ...
    def audio2feat(self,audio_path):
        ...
        for emb in result['segments']:
            ...
            #print(start_idx, end_idx, end_idx-start_idx, emb_end_idx, encoder_embeddings.shape)
